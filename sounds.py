...
chess_com_move = resource_path(os.path.join(sound_dir, "chess_com_move.mp3"))
...
try:
    if os.path.exists(chess_com_move):
        ...
        trimmed_move = resource_path(os.path.join(sound_dir, "trimmed", "move_click.mp3"))
...
try:
    ...
    CAPTURE_SOUND = pygame.mixer.Sound(resource_path(os.path.join(sound_dir, "Capture", "ripping-a-piece-of-paper-103913.mp3")))
...
try:
    ...
    CHECK_SOUND = pygame.mixer.Sound(resource_path(os.path.join(sound_dir, "checkmate", "ficha-de-ajedrez-34722.mp3")))
...
try:
    ...
    CHECKMATE_SOUND = pygame.mixer.Sound(resource_path(os.path.join(sound_dir, "Winning Moment", "11l-victory_beat-1749704511321-358765(1).mp3")))
